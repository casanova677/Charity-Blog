        ...
        <header id="header" class="tp-site-header tp-header-style-2">
            ...
            <nav class="navigation navbar navbar-default">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="/"><img src="{{ asset('assets/images/logo.png')}}" alt="logo" height="20%" width="20%"></a>
                            ...
                            <div class="col col-lg-3 col-md-3 col-sm-6">
                                <div class="widget about-widget">
                                    <div class="logo widget-title">
                                      <a href="/">  <img class="ft-logo-1" src="{{ asset('assets/images/logo.png')}}" alt="blog"></a>
                                       
                                    </div>
                                    <p>RCICU is the world’s largest humanitarian network and is guided by seven Fundamental Principles: humanity, impartiality, neutrality, independence, voluntary service, universality and unity. </p>                                    </p>
                                    <ul>
                                        <li>
